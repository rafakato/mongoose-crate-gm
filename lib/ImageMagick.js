  ...
  gm(attachment.path)
    ...
    .identify(function(error, attributes) {
      ...
      Object.keys(this._options.transforms).forEach(function(name) {
        ...
        this._setUpTransform(attachment, name, transform, outputFile, tasks, model[name], storageProvider)
      }.bind(this))
...
ImageMagick.prototype._setUpTransform = function(attachment, transformName, transform, outputFile, tasks, model, storageProvider) {
  var self = this
